...
Title.Text = "<b>EventMe!</b> <font size=\"10\">V3</font>"
	...
	for ModuleName, Module in pairs(game.ReplicatedStorage.Remotes.Events.GetEvents:InvokeServer()) do
		...
		TextButton.MouseButton1Click:Connect(function()
			local v1, v2 = pcall(function()
				setclipboard(tostring("--[[ Decompiled with EventME! V3. | @60nn13\n ModuleName: "..ModuleName.." ]] \n return "..getsyncmodule(Module)))
			end)
			if v1 then
				script.Parent.Main.select.Text = "Decompiled!"
				wait(1)
				script.Parent.Main.select.Text = "Select an Event Module to decompile"
			else
